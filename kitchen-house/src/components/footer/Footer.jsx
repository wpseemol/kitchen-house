const Footer = () => {
    return (
        <footer className="font-myPoppinsFont bg-neutral-100 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
            ...
            <div className="mx-6 py-10 text-center md:text-left">
                <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                    {/* <!-- TW Elements section --> */}
                    <div className="">
                        <h6 className="mb-4 flex items-center justify-center font-semibold capitalize md:justify-start">
                            <figure>
                                <img
